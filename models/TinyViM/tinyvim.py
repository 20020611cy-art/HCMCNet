...
from models.TinyViM.tvimblock import TViMBlock, Conv2d_BN, RepDW, FFN
...
class TinyViM(nn.Module):
    ...
    def __init__(self, layers, pretrained=None, embed_dims=None,
...
@register_model
def TinyViM_S(pretrained=False, **kwargs):
    model = TinyViM(
...
@register_model
def TinyViM_B(pretrained=False, **kwargs):
    model = TinyViM(
...
@register_model
def TinyViM_L(pretrained=False, **kwargs):
    model = TinyViM(
