...
class UPerHead(nn.Module):
    ...
    def __init__(self, in_channels= [64, 128, 384, 512], num_classes=2, channels=512, pool_scales=(1, 2, 3, 6), norm_layer=nn.BatchNorm2d, dropout_ratio=0.1, align_corners=False):
