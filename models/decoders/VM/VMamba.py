...
class SS2D(nn.Module):
    ...
    def forwardxv(self, x: torch.Tensor, mode="xv1a", omul=False, **kwargs):
        ...
        if mode in ["xv1"]:
            ...
            dts = F.conv1d(dts, dt_projs_weight.view(K * self.d_inner, self.dt_rank, 1), None,
        ...
        if mode in ["xv1a"]:
            ...
            dts = F.conv1d(dts.contiguous().view(B, -1, L), dt_projs_weight.view(K * self.d_inner, self.dt_rank, 1),
                           None, groups=K)
