...
"""Dataset Path"""
C.dataset_name = 'whu'
C.root_folder = '/mnt/d/data/WHU'
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.is_test = False
C.num_train_imgs = 5973
C.num_eval_imgs = 744
C.num_classes = 2
...
C.image_height = 256
C.image_width = 256
C.norm_mean = np.array([0.48502548, 0.4644499,  0.4249131 ])
C.norm_std = np.array([0.19499405, 0.18874461, 0.20146505])
