...
"""Dataset Path"""
C.dataset_name = 'SYSU'
C.root_folder = '/mnt/d/data/SYSU'
C.A_format = '.png'
C.B_format = '.png'
C.gt_format = '.png'
C.is_test = False
C.num_train_imgs = 12000
C.num_eval_imgs = 4000
C.num_classes = 2
...
C.image_height = 256
C.image_width = 256
C.norm_mean = np.array([0.39952732, 0.50684557, 0.43015309])
C.norm_std = np.array([0.23043139, 0.1835101,  0.18267662])
