...
class Engine(object):
    def __init__(self, custom_parser=None):
        ...
        if self.distributed:
            ...
            torch.cuda.set_device(self.local_rank)
            dist.init_process_group(backend="nccl", rank=self.local_rank, timeout=datetime.timedelta(seconds=18000), world_size=self.world_size)
    ...
    def inject_default_parser(self):
        ...
        p.add_argument('--local-rank', default=0, type=int,
